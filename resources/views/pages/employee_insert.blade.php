        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form method="post" action="{{ route('employee.input') }}" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="name" id="name" required placeholder="Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Email Verified </label>
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" name="email_verify" id="email_verify">
                                            </div>
                                        </div>
                                        <div class="form-group row">
